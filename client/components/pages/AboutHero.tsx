...
const stats = [
  { icon: AcademicCapIcon, value: '2000+', label: 'Students' },
  { icon: UserGroupIcon, value: '150+', label: 'Faculty' },
  { icon: BookOpenIcon, value: '25+', label: 'Years Experience' },
  { icon: TrophyIcon, value: '98%', label: 'Success Rate' },
]
      ...
      <div className="container-custom relative z-10">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-shadow-lg">
            About <span className="text-secondary-300">Sunrise Public School</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-primary-100 max-w-4xl mx-auto leading-relaxed">
            Since 1998, we have been committed to providing exceptional education that 
            empowers students to become confident, capable, and compassionate individuals 
